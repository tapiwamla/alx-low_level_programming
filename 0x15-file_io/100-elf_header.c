 ...
 * @e_ident: points to an array containing the ELF data.
 */
void print_data_encoding(unsigned char *e_ident)
{
printf(" Data:                              ");
...
/**
 *  * print_file_version - prints the version of an ELF header.
...
print_file_version(header->e_ident);
